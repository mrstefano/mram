...
import org.mrstefano.mram.activity.SelectActivity;
 ...
 *
 */
public class MrAudioManagerAppWidgetProvider extends AppWidgetProvider {
	...
	public static void updateAllWidgets(Context context, Parcelable data) {
	    AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(context);
	    ComponentName widgetComponentName = new ComponentName(context, MrAudioManagerAppWidgetProvider.class);
		int[] ids = appWidgetManager.getAppWidgetIds(widgetComponentName);
		if ( ids != null ) {
			new MrAudioManagerAppWidgetProvider().update(context, appWidgetManager, ids, data);
		}
		/*
